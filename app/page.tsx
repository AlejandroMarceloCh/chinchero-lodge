...
export default function Home(){return <main>
  ...
  <footer><div><a className="wordmark" href="#top">MESA ALTA</a><p>Independent hospitality, high in the Andes.<br/>Opening target: 2028.</p><div className="footer-links"><a href="https://instagram.com/alexheem" target="_blank" rel="noreferrer">Instagram ↗</a><a href="/invest">For investors ↗</a><span>Contact [CONFIRMAR]</span></div></div><img src="/images/footer-signoff.png" alt="Alex and Tuff walking away together"/></footer>
</main>}
